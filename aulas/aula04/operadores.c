...
int main() {
    ...
    printf("A divisao de %i e %i eh %f\n", numero1, numero2, divisao);
    printf("O resto_da_divisao de %i e %i eh %i\n", numero1, numero2, resto_da_divisao);
    

    // operadores incremento e decemrento
    int incremento = numero1;
    incremento ++; // numero = numero1 + 1
    int decremento = numero1; // numero = numero1 + 1
    ...
    printf ("O numero %i eh menor ou igual a %i? %i\n", numero1,
      numero2, menor_ou_igual);
    printf ("O numero %i eh maior %i? %i\n", numero1, numero2,
      maior_que);
    printf ("O numero %i eh maior ou igual a %i? %i\n", numero1, 
      numero2, maior_ou_igual);
